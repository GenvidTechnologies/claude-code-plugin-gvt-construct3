...
| Before you… | Read |
|---|---|
| Add or edit anything in `plugin/docs/c3/` | [Verifying docs/c3 against construct3-sample](wiki/verifying-against-construct3-sample.md) — the sample is ground truth, the ADR 0008 marker **scope**, and four traps that each shipped a wrong doc |
