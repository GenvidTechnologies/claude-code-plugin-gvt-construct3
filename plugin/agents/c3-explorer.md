...
This is your full read-only surface across both pinned servers (`construct3-chef@0.11.2`, `c3-domain-manager@0.6.1`). It is your hard `tools:` allow-list — anything not listed here you cannot call.
