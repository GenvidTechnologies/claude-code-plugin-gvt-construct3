...
This is your full read-only surface across both pinned servers (`construct3-chef@2.0.0`, `c3-domain-manager@0.11.0`). It is your hard `tools:` allow-list — anything not listed here you cannot call.
